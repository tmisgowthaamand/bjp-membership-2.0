...
export default function CandidateVerificationPage() {
  ...
  return (
    <div style={{
      minHeight: '100vh',
      background: 'linear-gradient(180deg, #0F172A 0%, #1A1512 100%)',
      color: '#FFFFFF',
      ...
      <header style={{
        ...
        background: '#1E293B',
        borderRadius: 16,
        border: '1.5px solid rgba(247, 98, 1, 0.3)'
      }}>
          ...
          <>
            ...
            <div
              ...
              style={{
                ...
                borderRadius: 22,
                boxShadow: '0 16px 40px rgba(247, 98, 1, 0.4)',
                display: 'flex',
                flexDirection: 'column',
                justifyContent: 'space-between',
                padding: '18px 14px',
            ...
            >
              ...
              <div style={{
                ...
                <div style={{ width: 38, height: 38, background: '#FFF3EB', borderRadius: '50%', border: '1px solid #FFCC99', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 3, flexShrink: 0 }}>
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid #F1F5F9', paddingBottom: 5 }}>
                  ...
                  <span style={{ fontWeight: 900, color: '#D85400', fontFamily: 'monospace', fontSize: 13 }}>{appData.application_id || appId}</span>
                </div>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid #F1F5F9', paddingBottom: 5 }}>
