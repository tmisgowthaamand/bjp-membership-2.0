...
export function getDistrictCentroidOffset(districtName = '') {
  ...
  const offsets = {
    ...
    ranipet: [0.02, -0.04],
    vellore: [-0.06, 0.0],
    tirupathur: [-0.08, -0.04],
    tirupattur: [-0.08, -0.04],
    kancheepuram: [-0.03, -0.06],
    kanchipuram: [-0.03, -0.06],
    chengalpattu: [0.08, 0.04],
    chengalpet: [0.08, 0.04],
    perambalur: [-0.04, -0.03],
    ariyalur: [0.08, 0.0],
    tiruchirappalli: [0.0, 0.0],
    trichy: [0.0, 0.0],
    thanjavur: [-0.04, 0.0],
    tiruvarur: [0.0, -0.06],
    thiruvarur: [0.0, -0.06],
    nagapattinam: [0.12, 0.16],
    mayiladuthurai: [0.06, -0.02],
    kanniyakumari: [0.0, -0.06],
    kanyakumari: [0.0, -0.06],
    dharmapuri: [0.0, -0.02],
    krishnagiri: [0.0, -0.04],
    cuddalore: [0.06, 0.0],
    pudukkottai: [0.0, 0.0],
    ramanathapuram: [0.08, 0.0],
    ramnad: [0.08, 0.0],
    tiruvannamalai: [0.02, 0.15],
    tvmalai: [0.02, 0.15],
    nilgiris: [-0.04, 0.0],
    coimbatore: [0.0, 0.0],
    tiruppur: [-0.03, 0.03],
